...
//go:generate minimock -i github.com/lookandhate/course_auth/internal/cache.UserCache -o user_cache_minimock.go -n UserCacheMock -p mocks
...
type UserCacheMock struct {
	...
	funcCreate          func(ctx context.Context, user *model.UserModel) (err error)
	inspectFuncCreate   func(ctx context.Context, user *model.UserModel)
	...
	funcGet          func(ctx context.Context, id int) (up1 *model.UserModel, err error)
...
func (mmCreate *mUserCacheMockCreate) Expect(ctx context.Context, user *model.UserModel) *mUserCacheMockCreate {
...
func (mmCreate *mUserCacheMockCreate) ExpectUserParam2(user *model.UserModel) *mUserCacheMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserCacheMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserCacheMockCreate) Inspect(f func(ctx context.Context, user *model.UserModel)) *mUserCacheMockCreate {
...
func (mmCreate *mUserCacheMockCreate) Set(f func(ctx context.Context, user *model.UserModel) (err error)) *UserCacheMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserCacheMockCreate) When(ctx context.Context, user *model.UserModel) *UserCacheMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserCacheMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserCacheMock) Create(ctx context.Context, user *model.UserModel) (err error) {
...
func (mmDelete *mUserCacheMockDelete) Expect(ctx context.Context, id int) *mUserCacheMockDelete {
...
func (mmDelete *mUserCacheMockDelete) ExpectIdParam2(id int) *mUserCacheMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserCacheMock.Delete mock is already set by Set")
	}
...
func (mmDelete *mUserCacheMockDelete) Inspect(f func(ctx context.Context, id int)) *mUserCacheMockDelete {
...
func (mmDelete *mUserCacheMockDelete) Set(f func(ctx context.Context, id int) (err error)) *UserCacheMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mUserCacheMockDelete) When(ctx context.Context, id int) *UserCacheMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserCacheMock.Delete mock is already set by Set")
	}
...
func (mmDelete *UserCacheMock) Delete(ctx context.Context, id int) (err error) {
...
func (mmGet *mUserCacheMockGet) Expect(ctx context.Context, id int) *mUserCacheMockGet {
...
func (mmGet *mUserCacheMockGet) ExpectIdParam2(id int) *mUserCacheMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserCacheMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserCacheMockGet) Inspect(f func(ctx context.Context, id int)) *mUserCacheMockGet {
...
func (mmGet *mUserCacheMockGet) Return(up1 *model.UserModel, err error) *UserCacheMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserCacheMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserCacheMockGet) Set(f func(ctx context.Context, id int) (up1 *model.UserModel, err error)) *UserCacheMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserCacheMockGet) When(ctx context.Context, id int) *UserCacheMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserCacheMock.Get mock is already set by Set")
	}
...
func (e *UserCacheMockGetExpectation) Then(up1 *model.UserModel, err error) *UserCacheMock {
...
func (mmGet *UserCacheMock) Get(ctx context.Context, id int) (up1 *model.UserModel, err error) {
