...
type UserRepositoryMock struct {
	...
	funcCreateUser          func(ctx context.Context, user *model.CreateUserModel) (i1 int, err error)
	inspectFuncCreateUser   func(ctx context.Context, user *model.CreateUserModel)
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Expect(ctx context.Context, user *model.CreateUserModel) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) ExpectUserParam2(user *model.CreateUserModel) *mUserRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Inspect(f func(ctx context.Context, user *model.CreateUserModel)) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Set(f func(ctx context.Context, user *model.CreateUserModel) (i1 int, err error)) *UserRepositoryMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserRepositoryMockCreateUser) When(ctx context.Context, user *model.CreateUserModel) *UserRepositoryMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *UserRepositoryMock) CreateUser(ctx context.Context, user *model.CreateUserModel) (i1 int, err error) {
